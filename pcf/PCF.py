...
class PCF:
    ...
    def is_inflation(self: PCF) -> bool:
        return sympy.gcd(self.b, self.a * self.a.compose(Poly(n - 1))) != 1
...
if __name__ == "__main__":
    b = sympy.Poly([-1, 14, -84, 280, -560, 672, -448, 128, 0], n)
    a = sympy.Poly([4, -56, 360, -1384, 3476, -5844, 6414, -4170, 1215], n)
    mypcf = PCF(a.all_coeffs(), (b * a.compose(sympy.Poly(n + 1))).all_coeffs())
    mypcf.deflate()
